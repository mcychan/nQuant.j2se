...
public class BitmapUtilities {
	...
	public static ColorModel createColorModel(final Color[] palette, int transparentPixelIndex, boolean hasSemiTransparency, boolean hasTransparency)
	{
		int nMaxColors = palette.length;
		...
		if(nMaxColors <= 256) {
			...
			return new IndexColorModel(getBitsPerPixel(nMaxColors),         // bits per pixel
				...
				palettes,   // color map
				0,         // offset in the map
				transparentPixelIndex > -1,      // has alpha
				transparentPixelIndex,         // the pixel value that should be transparent
		...
		else if (transparentPixelIndex > -1) {
